...
<html>
	...
	<body>
		...
		<div class="container" id="containers">
			...
			<div class="company-jio">
				<div class="background">
					<img src="images/cover_company/L&T_back.jpg" height=333px width="1350">
				</div>
				<div class="bottom-content">
					<div class="left-icon">
					<div class="icon-text" style="display: inline-block;">
						<div class="icon">
							<img src="images/company/company-l-and-t-technology-services.png" width=80px height=80px>
							<span><img src="images/star.png" width=25px height=25px>
							<span style="vertical-align: 2px;">4.0 &bull; 7K+ Reviews &bull; Its all about imagineering</span></span>
						</div>
					</div>
					</div>
		...
		if(isset($_POST['submit'])){
			header("location:https://www.larsentoubro.com/corporate/careers/");
			$RUN = mysqli_query($con,"UPDATE company_details SET `applied`='yes', `u_id`='$u_id' WHERE company_jobs='25K'");
		}
		?>
					</div>
					</div>
					...
					<div class="info-company">
						<div class="qualification">
							...
							<span style="font-size: 17px;"><ul>
								<li>Experience in ETL/DW testing, Cloud migration testing, BI Testing.</li>
								<li>Good experience in Writing complex SQL Queries to validate data quality and business transformations.</li>
								<li>Good Experience working in data migration programs on Snowflake cloud environment</li>
								<li>Good experience in reporting tools like Tableau, Power BI</li>
								<li>Strong experience in SQL and Unix is desirable</li>
								<li>Experience working on any Data Automation tools like QuerySurge/DataGaps/ any other frameworks is required.</li>
								<li>Exposure working on Databases like Teradata / SQL Server / Postgres SQL / Oracle is desirable.</li>
                                <li>Exposure working on any cloud like Azure / AWS is advantage.</li>
                                <li>Exposure working in Agile / POD based delivery model is desirable.</li>
                                <li>Good written and spoken communication skills</li>
