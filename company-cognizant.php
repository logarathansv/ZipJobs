...
<html>
	...
	<body>
		...
		<div class="container" id="containers">
			...
			<div class="company-jio">
				<div class="background">
					<img src="images/cover_company/cognizant_back.jpg" height=333px width="1350">
				</div>
				<div class="bottom-content">
					<div class="left-icon">
					<div class="icon-text" style="display: inline-block;">
						<div class="icon">
							<img src="images/company/company-cognizant-technology-solutions.png" width=80px height=80px>
							<span><img src="images/star.png" width=25px height=25px>
							<span style="vertical-align: 2px;">4.0 &bull; 86K+ Reviews &bull; Intuition engineered</span></span>
						</div>
					</div>
					</div>
		...
		if(isset($_POST['submit'])){
			header("location:https://careers.cognizant.com/professionals/in/en/");
			$RUN = mysqli_query($con,"UPDATE company_details SET `applied`='yes', `u_id`='$u_id' WHERE company_jobs='2.5T'");
		}
		?>
					</div>
					</div>
					...
					<div class="info-company">
						<div class="qualification">
							...
							<span style="font-size: 17px;"><ul>
								<li>Basic Qualifications: Bachelor’s or Master’s degree in Computer Science or related field from a top university.</li>
								<li>Experience with AI/ML/eCommerce/Digital Health/Marketplaces/Blockchain technologies/solutions.</li>
								<li>Experience with migrating workloads onto the cloud.</li>
								<li>A solid understanding of industry-wide technology strategies and best practices.</li>
								<li>Presentation skills with a high degree of comfort speaking with executives, IT Management, and developers.</li>
								<li>Solid Computer Science fundamentals, excellent problem-solving skills.</li>
								<li>Experience communicating architecture direction and decisions through presentations and clear architectural diagrams to engineering.</li>
							</ul>
							</span>
						</div>
					</div>
