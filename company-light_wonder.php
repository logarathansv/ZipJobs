...
<html>
	...
	<body>
		...
		<div class="container" id="containers">
			...
			<div class="company-jio">
				<div class="background">
					<img src="images/cover_company/LIGHT_AND_WONDER_back.jpg" height=333px width="1350">
				</div>
				<div class="bottom-content">
					<div class="left-icon">
					<div class="icon-text" style="display: inline-block;">
						<div class="icon">
							<img src="images/company/company-light.png" width=80px height=80px>
							<span><img src="images/star.png" width=25px height=25px>
							<span style="vertical-align: 2px;">4.0 &bull; 99K+ Reviews &bull; we build new worlds of play</span></span>
						</div>
					</div>
					</div>
		...
		if(isset($_POST['submit'])){
			header("location:https://www.lnw.com/careers");
			$RUN = mysqli_query($con,"UPDATE company_details SET `applied`='yes', `u_id`='$u_id' WHERE company_jobs='2K'");
		}
		?>
					</div>
					</div>
					...
					<div class="info-company">
						<div class="qualification">
							...
							<span style="font-size: 17px;"><ul>
								<li>Basic Qualifications: Bachelors degree in related field.</li>
								<li>Years of experience: 0 to 2 years.</li>
								<li>Develop, customize, and maintain Applications using Java.</li>
								<li>Strong understand and experience in cloud native applications.</li>
								<li>Object Oriented Design and Design Patterns.</li>
								<li>Experience building cloud native apps at the enterprise level for scale.</li>
								<li>Experience in developing application which utilise messaging extensively.</li>
							</ul>
							</span>
						</div>
					</div>
