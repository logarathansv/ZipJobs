...
<html>
	...
	<body>
		...
		<div class="container" id="containers">
			...
			<div class="company-jio">
				<div class="background">
					<img src="images/cover_company/reliance_back.jpg" height=333px width="1350">
				</div>
				<div class="bottom-content">
					<div class="left-icon">
					<div class="icon-text" style="display: inline-block;">
						<div class="icon">
							<img src="images/company/company-reliance.png" width=80px height=80px>
							<span><img src="images/star.png" width=25px height=25px>
							<span style="vertical-align: 2px;">4.0 &bull; 2K+ Reviews &bull; Growth is Life</span></span>
						</div>
					</div>
					</div>
		...
		if(isset($_POST['submit'])){
			header("location:https://careers.ril.com/rilcareers/");
			$RUN = mysqli_query($con,"UPDATE company_details SET `applied`='yes', `u_id`='$u_id' WHERE company_jobs='52T'");
		}
		?>
					</div>
					</div>
					...
					<div class="info-company">
						<div class="qualification">
							...
							<span style="font-size: 17px;"><ul>
								<li>Basic Qualifications:  Bachelor's degree in business administration, management, or a related field (Master's degree preferred).</li>
								<li>Previous experience in franchise operations or a similar role within the franchise industry.</li>
								<li>Strong knowledge of franchising regulations, policies, and best practices.</li>
								<li>Excellent interpersonal and communication skills.</li>
								<li>Proven ability to build and maintain relationships with diverse stakeholders.</li>
								<li>Analytical mindset with the ability to analyze operational data and identify improvement opportunities.</li>
								<li>Strong problem-solving and decision-making skills.</li>
								<li>Ability to travel domestically and internationally as required (approximately 25-30% of the time).</li>
							</ul>
							</span>
						</div>
					</div>
