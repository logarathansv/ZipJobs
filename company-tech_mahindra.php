...
<html>
	...
	<body>
		...
		<div class="container" id="containers">
			...
			<div class="company-jio">
				<div class="background">
					<img src="images/cover_company/tech_mahindra_back.jpg" height=333px width="1350">
				</div>
				<div class="bottom-content">
					<div class="left-icon">
					<div class="icon-text" style="display: inline-block;">
						<div class="icon">
							<img src="images/company/company-tech-mahindra.png" width=80px height=80px>
							<span><img src="images/star.png" width=25px height=25px>
							<span style="vertical-align: 2px;">4.0 &bull; 32K+ Reviews &bull; CONNECTED WORLD. CONNECTED EXPERIENCES</span></span>
						</div>
					</div>
					</div>
		...
		if(isset($_POST['submit'])){
			header("location:https://careers.techmahindra.com/");
			$RUN = mysqli_query($con,"UPDATE company_details SET `applied`='yes', `u_id`='$u_id' WHERE company_jobs='506'");
		}
		?>
					</div>
					</div>
					...
					<div class="info-company">
						<div class="qualification">
							...
							<span style="font-size: 17px;"><ul>
								<li>Basic Qualifications: A Bachelor's degree from any stream if a Fresher.</li>
								<li>Minimum HSC with a minimum of 1 year of relevant experience.</li>
								<li>Passionate about customer care.</li>
								<li>Good typing skill.</li>
								<li>Fluent in written and spoken English.</li>
								<li>Able to work well under pressure and under minimum supervision.</li>
								<li>A fast learner who is able to work with set targets.</li>
								<li>Must be time flexible and able to work in a rotational shift system</li>
                                <li>Including Public holidays and weekends.</li>
                                <li>International Non-voice Process.</li>
							</ul>
							</span>
						</div>
					</div>
